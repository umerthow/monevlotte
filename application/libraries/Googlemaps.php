...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyD_E-GFruSMcGrnfjaHj15SbjV_t7p-yyE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_height					= "350px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
