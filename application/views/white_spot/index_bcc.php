      	...
      	<div class="x_panel">
                  	...
                  	<div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <li>
                          <a href="#step-4">
                            ...
                            <span class="step_descr">
                                              Step 4<br />
                                              <small>Finish Transaction</small>
                                          </span>
                          </a>
                        </li>
                      </ul>
             ...
             <!--      	<div class="row form-group">
					...
					<div id="step-1">
								...
								<!-- <div class="col-md-12">
								<a href="javascript:void(0)" class="btn btn-primary pull-right next-payment"><span class="fa fa-arrow-circle-right"></span> NEXT</a>
