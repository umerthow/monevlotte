...
<div class="modal fade" tabindex="-1" role="dialog" id="formeditpassword">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="#" id="formepass" class="form-horizontal form-label-left"  novalidate>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
         ...
         <button id="send" type="button" class="btn btn-success btn-passok">Submit</button>
      </div>
...
function edit_psswd($id){

  alert('edit pasowrd?');
  $('.modal-title').text('Edit User Password');
  $('#formepass')[0].reset();
  save_method = 'update password';
  $('#formeditpassword').modal('show');

 


$('.btn-passok').on("click", function () {
      $('#submitpassword').text('saving..');
      $('#submitpassword').attr('disable',true);

      $.ajax({       
            url :"<?php echo  base_url()?>/user/update_password/"+$id,
            type: 'POST',
            data: $('#formepass').serialize(),
            cache:false,
            success: function(json){
               var obj = jQuery.parseJSON(json);
